...
/*Table structure for table `koo_category` */

DROP TABLE IF EXISTS `koo_category`;

CREATE TABLE `koo_category` (
...
/*Data for the table `koo_category` */
...
CREATE TABLE `koo_gig` (
  ...
  `gig_extra` varchar(100) DEFAULT NULL,
